...
const SingleTask = ({ task, handleDelete, openUpdateModal }) => {
        ...
        <>
            <div className="card bg-base-100 shadow-xl border">
                ...
                <div className="card-body">
                    ...
                    <div>
                        <hr />
                        <button onClick={() => openUpdateModal(_id)} className="mt-4 rounded-md py-2 px-4 bg-yellow-400 me-4">Edit</button>
